...
describe('leftSide', () => {
  ...
  it('renders properly with props', () => {
    ...
    expect(
      ...
      <div class="flex justify-around flex-wrap"><a target="_blank" aria-label="Label 1" href="url1" rel="noopener noreferrer" class="hover:text-blue-700 p-2 m-2">
          <component1-stub></component1-stub>
        </a><a target="_blank" aria-label="Label 2" href="url2" rel="noopener noreferrer" class="hover:text-blue-700 p-2 m-2">
