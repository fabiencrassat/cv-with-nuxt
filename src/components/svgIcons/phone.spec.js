...
describe('phone', () => {
  it('renders properly', () => {
    ...
    expect(testUtils.htmlFactory(phone)).toMatchInlineSnapshot(`
      <svg version="1.1" id="Phone" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve" class="h-5 w-5 inline mr-3 fill-current">
